...
return (new Config())
    ->withProfile(
        (new Profile('default'))
        ->withSuite(
            (new Suite('ui_managing_stripe_checkout_orders'))
            ->withPaths('features')
            ->withContexts(
            ...
            ->withContexts(
                ...
                'tests.flux_se.sylius_stripe_plugin.behat.context.setup.managing_orders.stripe_checkout',
            )
            ->withContexts(
            ...
            ->withFilter(new TagFilter('@managing_stripe_checkout_orders&&@ui')),
        ),
    )
;
