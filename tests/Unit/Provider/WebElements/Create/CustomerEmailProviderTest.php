...
final class CustomerEmailProviderTest extends TestCase
{
    ...
    {
        $this->provider = new CustomerEmailProvider();
    }

    public function test_it_sets_receipt_email_from_order_customer(): void
    {
        ...
        self::assertSame(['receipt_email' => 'oliver@doe.com'], $params);
    }

    public function test_it_omits_receipt_email_when_customer_has_no_email(): void
    {
    ...
    public function test_it_omits_receipt_email_when_order_has_no_customer(): void
    {
    ...
    public function test_it_omits_receipt_email_when_payment_has_no_order(): void
    {
